    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (service.equals("filter")) {
                ...
                String[] brand_name = request.getParameterValues("brand");
                ...
                request.setAttribute("brand_select", brand_name);
                request.setAttribute("min_price", min_price);
                request.setAttribute("max_price", max_price);
                request.setAttribute("discount_select", discount);
                
                list = d.search(category_name, brand_name, min_price, max_price, discount, order);
                    
                setCommonAttributes(request, d);
                request.setAttribute("listProduct", list);
//                request.setAttribute("linkProduct", d.link(category_name, brand_name, min_price,
