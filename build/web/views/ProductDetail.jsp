                    ...
                    <div class="col-md-5">
                        <div class="">
                            <div class="main-image rounded-sm overflow-hidden">
                                <img src="./images/${product.product_img}" alt="" id="main-image ">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="">
                            ...
                            <div class="d-flex align-items-center mt-5">
                                <div class="px-4 py-1 border-green rounded-sm">
                                    <span class="text-green fs-3 fw-bold">${product.getPriceAfterDiscount()}₫</span>
                                </div>
                                <div class="px-3">
                            ...
                            <div class="w-75 mt-5">
                                <h3 class="fw-semibold">Brand name: </h3>
                                <div class="d-flex flex-wrap gap-4 fs-4">
