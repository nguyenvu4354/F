                                       ...
                                       <div class="col-1 d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="col-2">
                                            <a href="ProductURL?Service=ProductDetail&Pid=<%=pro.getProduct_id()%>" class="d-block h-100">
                                                <img src="./images/<%=pro.getProduct_img()%>" alt="" class="rounded-lg object-fit-cover">
                                            </a>
                                        </div>
                                        <div class="col-9 d-flex flex-fill flex-column justify-content-between ">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative hover-change">
                                                        <div class="">
                                                            ...
                                                            <span class="text-black"><%=pro.getCategoryName()%></span>
                                                        </div>
                                                        <div class="border-line border-l mx-3"></div>
                                                        <div class="">
                                                            <i class="fa-solid fa-store me-3"></i>
                                                            <span class="text-black"><%=pro.getBrandName()%></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="">
                                            ...
                                            <div class="h-50 d-flex align-items-center justify-content-between">
                                                <%if(pro.getDiscount() > 0) {%>
                                                 <span class="text-white p-1 mx-2 fs-5 fw-bold bg-danger tag-sale">Giảm <%=pro.getDiscount()%>%</span>
                                                <%}%>
                                                <div class="ms-auto">
